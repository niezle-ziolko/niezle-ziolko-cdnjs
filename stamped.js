var StampedFn =
    ...
    (function (n, t) {
        ...
        function iu(t) {
            ...
            t
                ? (s("Started Rewards with JS data"), (e.customer = t), gi())
                : i.length > 0
            ...
            e && Object.keys(e.customer || {}).length === 0 && (e.customer = { customerId: i.data("customer-id") || (n.__st && n.__st.cid) || (n.meta && n.page && n.meta.page.customerId) });
        }
        function gi() {
            var t, u, f;
            ...
            setTimeout(function () {
                ...
                l
                    ? (console.log("Loading new FA css..."),
                      (c = "//s3-us-west-2.amazonaws.com/stamped.io/cdn/fontawesome/css/all-6.4.min.css"),
        ...
        function y(t, i, u, s = null) {
            ...
            if (
                ...
                if (t == "main")
                    ...
                    else for (v = 0; v < e.html.views.length; v++) (a = e.html.views[v]), a.key == t && (a.title && (h = a.title), (c = !0), tr(a.html), ir(t, h, u));
                    if (!c) {
                        tr();
                        ir(t, h, u);
                        w = null;
        ...
        function ir(n, t, i) {
            ...
            if (
                ...
                n == "view-earnings" &&
                    ...
                    l && (u = r('[data-event-type="celebrateBirthday"]', f)),
                ...
                function n() {
                    var n = $selectorInput.val(),
                        t = (n / w) * b,
                        i = new Intl.NumberFormat("en-US", { style: "currency", currency: p });
                ...
                function t(n) {
                    var t = r(n),
                        u = $selectorInput.val(),
                        f = { campaignId: i.entityId, points: u };
                    if (l) {
                        c(t, "loading", !0);
                        fr(
                            i.entityId,
                            ...
                            function (n) {
                                let r = n.code,
                                    i = n.title;
                                c(t, "active", !0, 1);
                                y("view-coupon", null, { couponCode: r, title: i, viewTitle: i });
                            },
                            null,
                            u
                        );
        ...
        function fr(t, i, u = null, f = null, s = null, c = null) {
            ...
            r.ajax({
                ...
                success: function (n) {
                    ...
                    h("stamped:rewards:redeemed", { detail: { customerId: n.customerId, event: n.event, code: n.code, title: n.title, rewardCampaignCoupon: { couponCode: n.code } } });
                },
                error: function () {
            ...
            i &&
                ...
                r.ajax({
                    ...
                    url:
                        ...
                        r.param({ apiKey: n.StampedGlobalOptions.apiKey, sId: n.StampedGlobalOptions.sId, storeUrl: n.StampedGlobalOptions.storeUrl, email: i, referralCode: u.referral_code, debug: null }),
                    dataType: "json",
                    success: function (n) {
        ...
        function c(n, t, i, r, u) {
            if (t == "loading") {
                ...
                i || n.html('<span class="stamped-button-icon stamped-button-completed"><i class="far fa-check"></i></span>'),
                    setTimeout(function () {
        ...
        function lu() {
            ...
            r(".stamped-sort-select").length &&
                ((i = u.attr("data-sort") || r(".stamped-container", u).attr("data-widget-sort")),
                i && ((c = r('.stamped-sort-select option[value="' + i + '"]')), c.css("display") && c.css("display") !== "none" && r(".stamped-sort-select").val(i)));
        }
        function au(n) {
            (u && u.length && !n) || (u = r(v));
            dt();
        ...
        function wu() {
            ...
            if (
                (t.points &&
                    ...
                    u.length && i >= 0 && ((s = u.attr("data-ratio")), (c = u.attr("data-symbol")), s && ((a = parseInt(s)), a && ((v = i > 0 ? (i / s).toFixed(2) : 0), u.html(c + v))))),
                ...
                .on("click keypress", i, function (t) {
                    ...
                    if (a(t) === !0) {
                        ...
                        r.ajax({
                            ...
                            data: { productId: l, reviewId: e, questionId: h, vote: c, apiKey: n.StampedGlobalOptions.apiKey, sId: n.StampedGlobalOptions.sId, storeUrl: n.StampedGlobalOptions.storeUrl },
                            success: function (n) {
            ...
            if (h != 1) {
                ...
                for (
                    ...
                    (v = u[f] == t),
                        v
                            ? r("#pages", e).append(
                                  ' <span class="page active"><a style="cursor:pointer;" onclick="StampedFn.pageQuestions(this)" role="button" tabindex="0" data-product-id="" data-page="' + u[f] + '">' + u[f] + "</a></span> "
                              )
        ...
        function no(n) {
            var t = oo("â˜…", n.reviewRating),
                ...
                o =
                    "https://www.facebook.com/dialog/feed?app_id=941057476855139&display=popup&link=" +
                ...
                if (((r = n[i]), t != !0 || r.reviewUserPhotos || r.reviewUserVideos)) {
                    if (
                        ...
                        if (r.reviewUserPhotos)
                            for (
                                o = r.reviewUserPhotos.split(","), h = "//cdn.stamped.io/uploads/photos/", r.reviewUserPhotosWatermark && (h = "//cdn.stamped.io/" + r.reviewUserPhotosWatermark + "/uploads/photos/"), ii = 0;
                                ii < o.length;
                                ii++
                            )
                ...
                ut = function (u, f) {
                    ...
                    if (e != null && e.photos != null) {
                                ...
                                e.photos[c] != null &&
                                    ...
                                    ut
                                        ? o.modal_ugc_image_viewer == "image"
                                            ? (r("video", r(".stamped-ugc-modal-image", p)).remove(),
                                              r(".stamped-ugc-modal-image", p).html('<img src="' + ut + '" alt="' + e.via + " photo uploaded by " + e.name + " on " + e.dateFull + '" />'))
                        ...
                        if (
                            ...
                            (ft = "Verified Buyer"),
                            (st = "Shop Now"),
                            v && l != "en" && ((ft = v.label_verified_buyer || ft), (st = v.label_shop_now || st)),
                ...
                g = function (n) {
                    ...
                    if (p.hasClass("open"))
                        if (((u = p.attr("data-review-index")), (f = p.attr("data-photo-index")), r('[data-direction="right"]', p).removeClass("nav-disabled"), r('[data-direction="left"]', p).removeClass("nav-disabled"), n == "left"))
                            ...
                            (i = r(".stamped-ugc-modal-list-photos ul li.active").next()),
                                r(i.click()),
                                i.length || (r('[data-direction="right"]', p).addClass("nav-disabled"), p.attr("data-modal-type") == "instagram" && h("stamped:ugcmodal:last"));
                        else return;
                };
            i != null && i.length && ut(u, c);
        }
                ...
                : ((i = new XMLHttpRequest()),
                  (i.onreadystatechange = function () {
                      ...
                      i.readyState === 4 &&
                          ...
                          n &&
                              n.apiKey &&
                              (ff(f, n), h("stamped:init:getAppKey", { detail: n }), n.skip === !0 || ((appKey = n.apiKey), (t = { apiKey: appKey }), typeof Shopify != "undefined" ? (t.storeUrl = Shopify.shop) : (t.sId = n.sId), fi(t))));
                  }),
                  (u = ""),
        ...
        if (
            ...
            pr || is("//cdn.jsdelivr.net/gh/niezle-ziolko/niezle-ziolko-cdnjs@latest/stamped.min.css"),
